            ...
            <div class={s.wrapper}>
              ...
              <Form onSubmit={onSubmit}>
                <FormItem label='邮箱地址' type='text' placeholder='请输入邮箱，然后点击发送验证码'
                  ...
                  <FormItem label='验证码' ref={refValidationCode} 
                    type='validationCode' countFrom={5} placeholder='请输入六位数字 ' 
                    onClick={onClickSendValidationCode} disabled={refDisabled.value}
